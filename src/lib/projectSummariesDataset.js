...
export const PROJECT_SUMMARIES = {
  ...
  "deepfunding/dependency-graph": {
    ...
    "rank": 92,
    "summary": "The deepfunding/dependency-graph project underpins Deep Funding, an innovative funding mechanism designed to allocate resources to Ethereum's open-source ecosystem by mapping the intricate web of dependencies between projects. By utilizing a directed dependency graph, Deep Funding shifts the focus from direct project valuation to understanding how much value each project derives from its dependencies, thereby ensuring that foundational libraries and tools receive fair compensation. This experimental approach, developed by notable figures including Vitalik Buterin, integrates expert evaluations, machine learning, and prediction markets to intelligently route funding, promoting a diverse and resilient Ethereum infrastructure. Its unique methodology will be trialed in Gitcoin's funding rounds, highlighting its potential to transform public goods funding in the Ethereum ecosystem. Overall, Deep Funding not only addresses the challenge of equitable resource distribution but also enhances the sustainability of the ecosystem by supporting a wide array of essential projects.",
    "input_tokens": 3055,
    "output_tokens": 171,
    "cost": 0.00056085,
